...
function filter_stage() {
  ...
  var filterValue = document
    .querySelector("#filterInput_stages")
    .value.toLowerCase();
...
function filter_groups() {
  // Obtén el valor del campo de búsqueda
  var filterValue = document
    .querySelector("#filterInput_groups")
    .value.toLowerCase();
  // Obtén las listas de elementos
...
function filter_users() {
  // Obtén el valor del campo de búsqueda
  var filterValue = document
    .querySelector("#filterInput_users")
    .value.toLowerCase();
...
function filterItems_contexmenu_groups() {
  // Obtén el valor del campo de búsqueda
  var filterValue_workspace = document
    .getElementById("filterInput_workspace_groups")
    .value.toLowerCase();

  // Obtén las listas de elementos
  var groupsContainer_workspace = document.getElementById(
    "groupsContainer_workspace"
  );

  // Obtén todos los elementos de las listas
  var groupsItems_workspace =
    groupsContainer_workspace.getElementsByClassName("item_workspace");
  ...
  for (var i = 0; i < groupsItems_workspace.length; i++) {
    ...
    if (
      group_item_contexmenu.textContent
        .toLowerCase()
        .includes(filterValue_workspace)
    ) {
      group_item_contexmenu.style.display = "flex";
    } else {
...
function filterItems_contexmenu_users() {
  // Obtén el valor del campo de búsqueda
  var filterValue_workspace = document
    .getElementById("filterInput_workspace_users")
    .value.toLowerCase();

  // Obtén las listas de elementos
  var usersContainer_workspace = document.getElementById(
    "usersContainer_workspace"
  );

  // Obtén todos los elementos de las listas
  var usersItems_workspace =
    usersContainer_workspace.getElementsByClassName("item_workspace");
  ...
  for (var i = 0; i < usersItems_workspace.length; i++) {
    ...
    if (
      users_item_contexmenu.textContent
        .toLowerCase()
        .includes(filterValue_workspace)
    ) {
      users_item_contexmenu.style.display = "flex";
    } else {
...
//funcion para cargar la data del paper 

// Define una variable para almacenar el contenido del papel en formato JSON.


// let contenidoPapelJSON =  {"cells":[]}



// const apiUrl_data = ""; // Reemplaza esto con la URL correcta


// axios
//   .get(apiUrl_data)
//   .then((response) => {
//     contenidoPapelJSON.splice(0);
//     // response.data.slice(0, 10)
//     contenidoPapelJSON.push(...response.data);
...
// console.log('data', contenidoPapelJSON.cells);

// if (contenidoPapelJSON.cells && contenidoPapelJSON.cells.length > 0) {
//    paper.model.fromJSON(contenidoPapelJSON);
// } else {
...
//     position: "center",
//     icon: "warning",
//     html: `<span class="text-white">No data received for the work area!</span> `,
